        ...
        <form @submit.prevent="submitJob" class="modern-form">
          ...
          <div class="card">
            ...
            <div class="card-content config-card-content">
              <div class="config-row">
                <div class="config-item">
                  <label class="config-label">第一項目（棒グラフ）</label>
                  <select v-model="parameters.output1" class="config-input">
                ...
                <div class="config-item">
                  <label class="config-label">第二項目（線グラフ）</label>
                  <select v-model="parameters.output2" class="config-input">
            ...
            <div class="card-content config-card-content">
              <div class="settings-section">
                <div class="section-header">
                  <h3 class="section-title">人口推計パターン</h3>
                </div>
                <select v-model="parameters.population" class="config-input full-width">
              ...
              <div class="settings-section">
                <div class="section-header">
                  <h3 class="section-title">前提条件パターン</h3>
                </div>
                <select 
                  v-model="parameters.selectedPremisePattern"
                  class="config-input full-width"
                >
              ...
              <div class="settings-section">
                <div class="section-header">
                  <h3 class="section-title">政策パターン</h3>
                </div>
                <select 
                  v-model="parameters.selectedPolicyPattern"
                  class="config-input full-width"
                >
                  <option value="">パターンを選択してください</option>
                  <option 
    ...
    methods: {
      ...
      async submitJob() {
        ...
        try {
          ...
          const filename = `single_simulation_${timestamp}.json`;
  
          const requestBody = {
            filename: filename,
            contentType: 'application/json',
            simulationParams: parameterData,
            function: 'single'  // single simulation用の関数名を指定
          };
